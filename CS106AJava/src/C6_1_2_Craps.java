/*
 * File: C6_1_2_Craps.java
 * -----------------------
 * This program plays the casino game of Craps. At the beginning of the game,
 * the player rolls a pair dice and computes the total. If the total is 2, 
 * 3, or 12 (called "craps"), the player loser. If the total is 7 or 11
...
public class C6_1_2_Craps extends ConsoleProgram {
