/**
 * The C6_2_4_Student class keeps track of the following pieces of data
 ...
 */
	public C6_4_2_Student(String name, int id) {
		studentName = name;
		studentID = id;
	}
