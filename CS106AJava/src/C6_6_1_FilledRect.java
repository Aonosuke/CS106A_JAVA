 ...
 * outlined.
 */
public class C6_6_1_FilledRect extends GRect {
	
	/** Creates a new FilledRect with the specified bounds. */
	public C6_6_1_FilledRect(double x, double y, double width, double height) {
		super(x, y, width, height);
		setFilled(true);
	}
	
	/** Creates a new FilledRect with the specified bounds and color. */
	public C6_6_1_FilledRect(double x, double y, double width, double height, Color color) {
