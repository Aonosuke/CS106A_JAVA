/**
 * The Rational Rational class is used to represent rational  numbers, which
 * are defined to be the quotient of two integers.
 */
public class C6_5_Rational {
	
	/** Creates a new Rational initialized to zero. */
	public C6_5_Rational() {
		this(0);
	}
	 ...
	 */
	public C6_5_Rational(int x, int y) {
	 ...
	 */
	public C6_5_Rational add(C6_5_Rational r) {
		return new C6_5_Rational(this.num * r.den + r.num * this.den, 
							this.den * r.den);
	}
	 ...
	 */
	public C6_5_Rational subtract(C6_5_Rational r) {
		return new C6_5_Rational(this.num * r.den - r.num * this.den, 
							this.den * r.den);
	}
	 ...
	 */
	public C6_5_Rational multiply(C6_5_Rational r) {
		return new C6_5_Rational(this.num * r.num, this.den * r.den);
	}
	 ...
	 */
	public C6_5_Rational divide(C6_5_Rational r) {
		return new C6_5_Rational(this.num * r.den, this.den * r.num);
	}
